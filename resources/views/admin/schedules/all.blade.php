													...
													<div class="col-md-12">
														<div class="card schedule-widget mb-0">
															...
															<div class="schedule-header">
																...
																<div class="schedule-nav">
																	<ul class="nav nav-tabs nav-justified">
																		...
																		<li class="nav-item">
																			<a class="nav-link {{ $key=='' ? 'active' : '' }}" data-toggle="tab" href="#slot_{{$item->name}}">{{$item->name}}</a>
																		</li>
                                                                        @endforeach
																		<!-- <li class="nav-item">
															...
															<div class="tab-content schedule-cont">
                                                                ...
                                                                @if($schedule)
                                                                <div id="slot_{{$schedule->alldays->name}}" class="tab-pane fade show active">
																	<h4 class="card-title d-flex justify-content-between">
																		<span>Time Slots</span> 
																	...
																	<div class="doc-times">
                                                                        @foreach ($schedule->worktimes as $key => $worktime)
                                                                ...
                                                                @else
                                                                <div id="slot_{{$schedule->alldays->name}}" class="tab-pane fade">
																	<h4 class="card-title d-flex justify-content-between">
																		<span>Time Slots</span> 
																		<a class="edit-link" data-toggle="modal" href="#add_time_slot"><i class="fa fa-plus-circle"></i> Add Slot</a>
																	</h4>
